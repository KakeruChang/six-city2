<template>
  <div class="share-proud">
    <picture class="proud-side-title">
      <source
        :srcset="require('../../assets/Tainan/SVGWord/Tainan_proud_mob.svg')"
        media="(max-width: 767.8px)"
      />
      <img :src="require('../../assets/Tainan/SVGWord/Tainan_proud.svg')" alt />
    </picture>
    <ArticleContainer backgroundColor="transparent">
      <div class="proud-title" v-if="isMob">
        <h2 style="margin: 0">分享台南市讓你</h2>
        <h2>驕傲的地方</h2>
      </div>
      <h2 class="proud-title" v-else>分享台南市讓你驕傲的地方</h2>
      ...
      <div class="link-wrapper">
        ...
        <router-link class="link-next link-lg" to="./Kaohsiung" target="_blank">
          <span @click="goToNext">下一篇：高雄市</span>
        </router-link>
      </div>
    </ArticleContainer>
  </div>
      ...
      metas: [
        {
          ...
          url: '/sharing/life',
          id: 'tainan-meta-1',
          img: require('../../assets/Tainan/share/Tainan_sharing_life.jpg')
        },
        {
          text: '美食',
          url: '/sharing/gourmet',
          id: 'tainan-meta-2',
          img: require('../../assets/Tainan/share/Tainan_sharing_food.jpg')
        },
        {
          text: '小巷弄',
          url: '/sharing/lane',
