...
const articleContent = [
  {
    ...
    meta: {
      title: '走入歷史的誠品敦南店 | 專題 | 聯合報',
      description:
        '誠品敦南店是全球首家24小時書店，也曾是台北的城市之光，而隨著誠品敦南店吹起熄燈號，一個世代的象徵也劃下句點。'
    }
  },
  {
    titleOut: '在北車停下腳步的理由',
    GATitle: 'page read: 在北車停下腳步的理由',
    textOut: [
    ...
    meta: {
      title: '在北車停下腳步的理由 | 專題 | 聯合報',
      description:
        '每次經過台北車站，腳步都得加快好幾倍，才能跟上台北人的步伐。但在北車，仍有幾間老字號書店，努力撐起幾個讓人停下腳步的空間，同時延續著台北書店街的書香味。'
    }
  },
  {
    titleOut: '台北人的使命感',
    GATitle: 'page read: 台北人的使命感',
    textOut: [
    ...
    meta: {
      title: '台北人的使命感 | 專題 | 聯合報',
      description:
        '台北人常被冠上許多負面詞彙：驕傲、自以為是、天龍人…身處台灣首都，台北人到底有什麼特別？'
    }
  },
  {
    titleOut: '上凱道的一百種方式',
    GATitle: 'page read: 上凱道的一百種方式',
    textOut: [
    ...
    meta: {
      title: '上凱道的一百種方式 | 專題 | 聯合報',
      description:
        '總統府前的凱道有一百種使用方式，不同團體都可以走上凱道，讓自己的聲音被政府和社會聽見，但凱道成為人民的凱道，也不過是近20多年的事而已‧‧‧'
    }
  },
  {
    titleOut: '迎向陽光的同志文化',
    GATitle: 'page read: 台北 迎向陽光的同志文化',
    textOut: [
    ...
    meta: {
      title: '迎向陽光的同志文化 | 專題 | 聯合報',
      description:
        '對台北的同志族群來說，西門町紅樓後方的露天廣場是讓他們「從地下室走到陽光下」的小天地，為什麼這個廣場對同志來說這麼重要？'
    }
  },
  {
    titleOut: '用喜劇收服難搞的台北人',
    GATitle: 'page read: 用喜劇收服難搞的台北人',
    textOut: [
    ...
    meta: {
      title: '用喜劇收服難搞的台北人| 專題 | 聯合報',
      description:
        '什麼樣的笑話才會讓台北人買單？台北人觀賞喜劇的心態，有什麼不同？卡米地喜劇俱樂部不斷用喜劇挑戰台北人的笑點，與台北人交手14年來，也學會從台北人的笑聲中，聽出不少端倪。'
    }
  },
  {
    titleOut: '台北人的味蕾',
    GATitle: 'page read: 台北人的味蕾',
    textOut: [
    ...
    meta: {
      title: '台北人的味蕾| 專題 | 聯合報',
      description:
        '台北餐廳的汰換率就跟台北人的步調一樣快，未來，台北人的餐桌上將呈現什麼風景？'
    }
  },
  {
    GATitle: 'page read: 台北 連接上下20年的文字',
    textOut: [
  ...
  },
  {
    ...
    GATitle: 'page read: 為什麼台北需要銅鑼灣書店',
    textOut: [
    ...
    meta: {
      title: '為什麼台北需要銅鑼灣書店？| 專題 | 聯合報',
      description:
        '香港的銅鑼灣書店來台灣重啟，是店長林榮基觀察到，儘管有再多獨立書店，台北仍需要一間「銅鑼灣書店」。'
    }
  },
  {
    titleOut: '台北正處於矛盾、拉扯狀態',
    GATitle: 'page read: 台北正處於矛盾、拉扯的狀態',
    textOut: [
      '經過不斷對話與討論，台北的各種對立與衝突，終將找到妥協的空間，舊思維和新思維也會找到一個平衡點。'
    ],
    inside: {
      title: ['左轉有書張慧如：', '台北正處於矛盾、拉扯狀態']
    },
    url: 'paradox',
    id: 'paradox',
    sideTitleImg: SideTitleImg20Years,
    ...
    meta: {
      title: '台北正處於矛盾、拉扯的狀態| 專題 | 聯合報',
      description:
        '「矛盾、衝突」是台北的現況，而經過不斷的對立、碰撞，台北將往什麼方向前進？'
    }
  }
]
